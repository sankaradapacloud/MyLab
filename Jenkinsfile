   ...
   // }
    stages {
        ...
        stage ('Publish the artifacts to Nexus'){
            steps {
                nexusArtifactUploader artifacts: [[artifactId: 'mylab', classifier: '', file: 'target/mylab-0.1.0-SNAPSHOT.war', type: 'war']], credentialsId: '4e8fde3b-05cf-42a2-8786-91ad79f3bb98', groupId: 'com.sankardevopslab', nexusUrl: '172.20.10.187:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'sankar-SNAPSHOT', version: '0.1.0-SNAPSHOT'
